...
def dyn_0(x, args):
    J1, J2, J3, m1, m2, m3, l1, l2, l3, g = args
    q1, q2, q3, dq1, dq2, dq3 = x

    # Inertia matrix
    xMc = np.array([
        [J2 + J3 + m2 * l1 * l2 * np.cos(q2) + 2 * m3 * l1 * l2 * np.cos(q2) + m3 * l2 * l3 * np.cos(q3) + m3 * l1 * l3 * np.cos(q2 + q3) + J1 + (1/4) * m1 * l1**2 + m3 * l2**2 + (1/4) * m3 * l3**2 + m2 * l1**2 + m3 * l1**2 + (1/4) * m2 * l2**2, 
         J2 + J3 + (1/2) * m2 * l1 * l2 * np.cos(q2) + m3 * l1 * l2 * np.cos(q2) + m3 * l2 * l3 * np.cos(q3) + (1/2) * m3 * l1 * l3 * np.cos(q2 + q3) + m3 * l2**2 + (1/4) * m3 * l3**2 + (1/4) * m2 * l2**2, 
         J3 + (1/2) * m3 * l2 * l3 * np.cos(q3) + (1/2) * m3 * l1 * l3 * np.cos(q2 + q3) + (1/4) * m3 * l3**2],
        [J2 + J3 + (1/2) * m2 * l1 * l2 * np.cos(q2) + m3 * l1 * l2 * np.cos(q2) + m3 * l2 * l3 * np.cos(q3) + (1/2) * m3 * l1 * l3 * np.cos(q2 + q3) + m3 * l2**2 + (1/4) * m3 * l3**2 + (1/4) * m2 * l2**2, 
         m3 * l2 * l3 * np.cos(q3) + (1/4) * m2 * l2**2 + m3 * l2**2 + (1/4) * m3 * l3**2 + J2 + J3, 
         (1/2) * m3 * l2 * l3 * np.cos(q3) + (1/4) * m3 * l3**2 + J3],
        [J3 + (1/2) * m3 * l2 * l3 * np.cos(q3) + (1/2) * m3 * l1 * l3 * np.cos(q2 + q3) + (1/4) * m3 * l3**2, 
         (1/2) * m3 * l2 * l3 * np.cos(q3) + (1/4) * m3 * l3**2 + J3, 
         J3 + (1/4) * m3 * l3**2]
    ])
